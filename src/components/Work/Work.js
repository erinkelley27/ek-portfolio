    ...
    return (
      <div className='work'>
        ...
        <div className='work-block'>
          ...
          <a href='https://bunble.herokuapp.com/' target='_blank'><img src={require('./bunble.png')} alt='bunble' className='work-img' /></a>
        ...
        <div className='work-block'>
          ...
          <a href='http://helium-vacations.surge.sh/' target='_blank'><img src={require('./love-away.png')} alt='love away vacations' className='work-img' /></a>
        ...
        <div className='work-block'>
          ...
          <a href='#' target='_blank'><img src={require('./love-away.png')} alt='hangman' className='work-img' /></a>
