  ...
  render () {
    return (
      <div className='work'>
        ...
        <div className='box'>
          <a href='https://erinkelley27.github.io/project1-hangman/' target='_blank' className='click-for-site'><p className='work-header'>HANGMAN</p></a>
          ...
          <a href='https://erinkelley27.github.io/project1-hangman/' target='_blank'><img src={require('./hangman.png')} alt='hangman' className='app-img' /></a>
          <a href='https://erinkelley27.github.io/project1-hangman/' target='_blank' className='click-for-site'><p className='click-for-site-text'>Click for Site</p></a>
        </div>
